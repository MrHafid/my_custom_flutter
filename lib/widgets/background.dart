...
const List<Color> aquaGradients = [
  Color.fromRGBO(170, 128, 249, 1),
  Color.fromRGBO(134, 114, 232, 1),
  Color.fromRGBO(97, 101, 215, 1),
];
...
class CirclePink extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
      ...
      child: Material(
        color: Color.fromRGBO(253, 128, 160, 1),
...
class CircleYellow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
      ...
      child: Material(
        color: Color.fromRGBO(255, 196, 68, 1),
